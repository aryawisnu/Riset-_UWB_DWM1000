...
byte       DW1000Class::_preambleCode        = PREAMBLE_CODE_16MHZ_3;
...
void DW1000Class::getPrintableExtendedUniqueIdentifier(char msgBuffer[]) { //char msgBuffer[]
	byte data[LEN_EUI];
	readBytes(EUI, NO_SUB, data, LEN_EUI);
	sprintf(msgBuffer, "%02X",
					data[7]);
}
